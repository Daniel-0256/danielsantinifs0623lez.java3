...
*/
characters.push(name[0], name[1], name[2], name[3], name[4], name[5], name[6], name[7], name[8], name[9])
...
femaleCharacters.push(starWarsCharacters[4], starWarsCharacters[6])
...
switch(eye_color) {
  case blu:
    console.log(starWarsCharacters[1, 6, 7])
    case yellow:
      console.log(starWarsCharacters[2, 4])
} 
